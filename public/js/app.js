...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CompareProject.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CompareProject.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.pageLoad(); // console.log("create_UUID. -> ", create_UUID());

    this.searchByFilters(); // console.log("amountInWords -> 10000 -> ", amountInWords(10000));
    // console.log(
  ...
  watch: {// filteredProjects: function (val) {
    //   this.filteredProjects = val;
    //   alert(JSON.stringify(val));
    // },
  },
  mounted: function mounted() {
    console.log("Component mounted."); // let externalScript = document.createElement('script')
  ...
  methods: {
    ...
    changeCompareProjectUnits: function changeCompareProjectUnits(index, selectedProject) {
      try {
        // console.log("changeCompareProjectUnits -> selectedProjectUnit -> " , JSON.stringify(selectedProject));
        var arrProjectUnit = selectedProject.units.filter(function (x) {
          return x.id == selectedProject.selectedProjectUnitId;
        });
        ...
        var changedProjectUnit = arrProjectUnit[0]; // console.log("changedProjectUnit -> New", changedProjectUnit.id);
        // console.log(
        ...
        var idsArr = [];
        this.arrProjectsCompare.forEach(function (compareProject) {
          idsArr.push(compareProject.selectedProjectUnitId); // console.log("forEach -> previousSelectedProjectUnit -> ",value.previousSelectedProjectUnit.id);
        ...
        this.arrProjectsCompare[index].selectedProjectUnitId = changedProjectUnit.id;
        this.reGenerateRoomTypesWithRooms(); // console.log("this.arrProjectsCompare[index].selectedProjectUnitId -> ", this.arrProjectsCompare[index].selectedProjectUnitId);
        // console.log("this. arrDistinctRoomTypes -> " , JSON.stringify(this.arrDistinctRoomTypes));
        // console.log("this. arrDistinctRoomTypes -> " , JSON.stringify(this.arrDistinctRoomTypes));

        if (this.arrProjectsCompare.filter(function (x) {
          return x.selectedProjectUnit.id == changedProjectUnit.id;
        }).length == 2) {
          ...
          this.arrProjectsCompare[index].selectedProjectUnitId = this.arrProjectsCompare[index].previousSelectedProjectUnitId;
          this.reGenerateRoomTypesWithRooms(); // Vue.set(this.arrProjectsCompare, index, this.arrProjectsCompare[index]);

          return;
        } else {
          this.arrProjectsCompare[index].previousSelectedProjectUnit = this.arrProjectsCompare[index].selectedProjectUnit;
          this.arrProjectsCompare[index].previousSelectedProjectUnitId = this.arrProjectsCompare[index].selectedProjectUnitId; // console.log("index_2", index);
    ...
    addToCompare: function addToCompare() {
      ...
      if (SubmitForm("frmAddToCompare")) {
        if (this.arrProjectsCompare.filter(function (x) {
          return x.id == _this.newCompareReord.project.id && x.selectedProjectUnit.id == _this.newCompareReord.projectUnit.id;
        }).length > 0) {
        ...
        this.newCompareReord.project.previousSelectedProjectUnitId = this.newCompareReord.projectUnit.id;
        this.newCompareReord.project.selectedProjectUnitId = this.newCompareReord.projectUnit.id; // this.newCompareReord.project.selectedProjectUnit.unitRoomTypes = this.reGenerateRoomTypesWithRooms(this.newCompareReord.project.selectedProjectUnit);
        ...
        var newProject = JSON.stringify(this.newCompareReord.project); // console.log("newProject, -> ", newProject);

        newProject = JSON.parse(newProject); // newProject.unit_id = this.newCompareReord.projectUnit.id;
        ...
        var idsArr = [];
        this.arrProjectsCompare.forEach(function (compareProject, index) {
          idsArr.push(compareProject.selectedProjectUnit.id); // console.log("forEach -> previousSelectedProjectUnit -> ",compareProject.previousSelectedProjectUnit.id);
        });
        this.reGenerateRoomTypesWithRooms();
        this.findCompareProjectUtilities();
        this.findCompareProjectAmenities(); // console.log("addToCompare -> this.arrProjectsCompare -> ", JSON.stringify(this.arrProjectsCompare));
      }
    },
    deleteCompareProject: function deleteCompareProject(Record) {
      // console.log("this.arrProjectsCompare -> ", this.arrProjectsCompare);
      // console.log("Deleted Record -> ", Record);
      this.arrProjectsCompare = this.arrProjectsCompare.filter(function (x) {
        return x.RecId != Record.RecId;
      });
      this.reGenerateRoomTypesWithRooms();
      this.findCompareProjectUtilities();
    ...
    changeProject: function changeProject() {
      this.filteredProjectUnits = this.newCompareReord.project.units; // console.log("this.newCompareReord.project -> ", JSON.stringify(this.newCompareReord.project));
    },
    ...
    searchByFilters: function searchByFilters() {
      var _this2 = this;

      ShowLoader();
      axios.post("/filter-compare-projects", this.searchFilter).then(function (response) {
        try {
          if (response.data.status) {
            _this2.arrRoomTypes = response.data.roomTypes;
            _this2.filteredProjects = response.data.data;

            if (isNormalInteger(_this2.selectedprojectid)) {
              // console.log("this.selectedprojectid -? ", this.selectedprojectid);
              var checkProjectisExist = _this2.filteredProjects.filter(function (x) {
                return x.id == _this2.selectedprojectid;
              ...
              if (checkProjectisExist.length > 0) {
                ...
                _this2.newCompareReord.project = checkProjectisExist[0];

                _this2.changeProject();
              }
            }
    ...
    reGenerateRoomTypesWithRooms: function reGenerateRoomTypesWithRooms() {
      var _this3 = this;

      this.arrDistinctRoomTypes = [];
      this.arrProjectsCompare.forEach(function (project) {
        // let arrUnitRoomTypes = [];
        project.selectedProjectUnit.unit_rooms.forEach(function (x) {
          if (_this3.arrDistinctRoomTypes.filter(function (y) {
            return y.room_type_id == x.room_type_id;
          }).length < 1) {
            _this3.arrDistinctRoomTypes.push({
      ...
      this.arrProjectsCompare.forEach(function (project) {
        var arrUnitRoomsWithType = [];

        _this3.arrDistinctRoomTypes.forEach(function (roomType) {
          var arrUnitTypeRooms = project.selectedProjectUnit.unit_rooms.filter(function (x) {
            return x.room_type_id == roomType.room_type_id;
          });
    ...
    findCompareProjectUtilities: function findCompareProjectUtilities() {
      var _this4 = this;

      this.compareProjectUtilsIsFound = false;
      this.arrProjectsCompare.forEach(function (projectCompare) {
        if (projectCompare.project_utils.length > 0) {
          _this4.compareProjectUtilsIsFound = true;
        }
      });
    },
    findCompareProjectAmenities: function findCompareProjectAmenities() {
      var _this5 = this;

      this.compareProjectAmenitiesIsFound = false;
      this.arrProjectsCompare.forEach(function (projectCompare) {
        if (projectCompare.project_amenities.length > 0) {
          _this5.compareProjectAmenitiesIsFound = true;
        }
      });
    },
    WordAmount: function WordAmount(amount) {
      return amountInWords(amount);
    },
    AmountConvertToHalfWord: function AmountConvertToHalfWord(amount) {
...
function BindColumnSelectBox() {
  ...
  $(".column-select-box > .evt").off("click").on("click", function (event) {
    event.stopPropagation();
    if ($(this).next().next(".columns").is(":visible")) $(this).next().next(".columns").slideUp();else $(this).next().next(".columns").slideDown();
  });
}

function DestroyDatatable(tblId) {
  var tbls;
  if ((tblId || "") == "") tbls = $(".tblJqueryDataTable");else tbls = $("#" + tblId + ".tblJqueryDataTable");
  tbls.each(function () {
    var tbl = $(this);
...
function AttachDatatable(tblId) {
  ...
  var table = $('table.' + tblId).DataTable(); // Apply the search
...
function ValiadteInputs() {
  $("input:enabled[data-maxlength],input:enabled[numtxt],input:enabled[decimaltxt],input:enabled[nospacetxt]").on("keypress", function (e) {
    ...
    if (_typeof(nospacetxt) !== ( true ? "undefined" : 0) && nospacetxt !== false || _typeof(numtxt) !== ( true ? "undefined" : 0) && numtxt !== false || _typeof(decimaltxt) !== ( true ? "undefined" : 0) && decimaltxt !== false) if (charCode == 32) return false;

    if (charCode == 32 || charCode == 8 || charCode == 9 || charCode >= 35 && charCode <= 40 && mod != 2) {
      return true;
    }

    if (_typeof(numtxt) !== ( true ? "undefined" : 0) && numtxt !== false) {
      if (!("0123456789".indexOf(keychar) > -1)) {
        return false;
      }
    }

    if (_typeof(decimaltxt) !== ( true ? "undefined" : 0) && decimaltxt !== false) {
      if (!("0123456789.".indexOf(keychar) > -1)) {
        return false;
    ...
    if (_typeof(charLimit) !== ( true ? "undefined" : 0) && charLimit !== false) {
...
function SubmitForm(FormID) {
  ...
  $("#" + FormID + " input:enabled").each(function (i, e) {
    if ($(e).is(":visible")) {
      ...
      if (_typeof(required) !== ( true ? "undefined" : 0) && required !== false && ($(e).val() || "") == "") {
        ...
        if (_typeof(maxlength) !== ( true ? "undefined" : 0) && maxlength !== false) {
  ...
  if ($("#" + FormID + " .form-group.error").length > 0) return false;else return true;
}
...
function ShowError(ErrorMsg, ClosesCallbackFunction) {
  ...
  $("#divError").modal({
    ...
    if (ClosesCallbackFunction !== undefined) ClosesCallbackFunction();
  });
}
...
function CallLaravelAction(RequestUri, Params, CallbackFunction) {
...
function GetFormattedDate(date) {
  var is_timestamp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
function time_difference(starttime, endtime) {
  ...
  var diffb = +b[0] * 60 * 60 + +b[1] * 60 + +b[2]; // minutes are worth 60 seconds. Hours are worth 60 minutes.
...
function time_difference_without_seconds(starttime, endtime) {
  ...
  var b = endtime.split(':'); // var diffa = ((+a[0]) * 60 * 60 + (+a[1]) * 60 + (+a[2]));
  // var diffb = ((+b[0]) * 60 * 60 + (+b[1]) * 60 + (+b[2]));

  var diffa = +a[0] * 60 * 60 + +a[1] * 60;
  var diffb = +b[0] * 60 * 60 + +b[1] * 60; // alert(JSON.stringify(diffa));
...
function ThousandSeparator(Number) {
  ...
  if (components.length === 1) components[0] = Number.toString();
...
function ConvertAmountToHalfWord(amount) {
  var number = amount; // console.log("number -> ", number);
  ...
  if (length == 3) {
    // Thousand
    number = number / 1000; // console.log("number = number / 1000; -> " , number);
    ...
    // Lakhs
    number = number / 100000; // console.log("number = number / 100000; -> " , number);
    ...
    // Crores
    number = number / 10000000; // console.log("number = number / 10000000; -> " , number);
    ...
    // Crores
    number = number / 1000000000; // console.log("number = number / 1000000000; -> " , number);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _public_js_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/js/helper */ "./public/js/helper.js");
/* harmony import */ var _public_js_helper__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_public_js_helper__WEBPACK_IMPORTED_MODULE_0__);
 ...
 */
// require('./bootstrap');
// require("../../public/js/helper");

window.Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.esm.js")["default"];
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // Vue.loadScript("../../public/js/helper")
...
Vue.component('compare-project', __webpack_require__(/*! ./components/CompareProject.vue */ "./resources/js/components/CompareProject.vue")["default"]);
...
/***/ "./resources/js/components/CompareProject.vue":
/*!****************************************************!*\
  !*** ./resources/js/components/CompareProject.vue ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CompareProject_vue_vue_type_template_id_7fa95b9f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CompareProject.vue?vue&type=template&id=7fa95b9f& */ "./resources/js/components/CompareProject.vue?vue&type=template&id=7fa95b9f&");
/* harmony import */ var _CompareProject_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CompareProject.vue?vue&type=script&lang=js& */ "./resources/js/components/CompareProject.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _CompareProject_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _CompareProject_vue_vue_type_template_id_7fa95b9f___WEBPACK_IMPORTED_MODULE_0__.render,
  _CompareProject_vue_vue_type_template_id_7fa95b9f___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/CompareProject.vue"
...
/***/ "./resources/js/components/CompareProject.vue?vue&type=script&lang=js&":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/CompareProject.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CompareProject_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CompareProject.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CompareProject.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CompareProject_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/components/CompareProject.vue?vue&type=template&id=7fa95b9f&":
/*!***********************************************************************************!*\
  !*** ./resources/js/components/CompareProject.vue?vue&type=template&id=7fa95b9f& ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CompareProject_vue_vue_type_template_id_7fa95b9f___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CompareProject_vue_vue_type_template_id_7fa95b9f___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CompareProject_vue_vue_type_template_id_7fa95b9f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CompareProject.vue?vue&type=template&id=7fa95b9f& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CompareProject.vue?vue&type=template&id=7fa95b9f&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CompareProject.vue?vue&type=template&id=7fa95b9f&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CompareProject.vue?vue&type=template&id=7fa95b9f& ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _vm._m(0),
    _vm._v(" "),
    _c("div", { staticClass: "row mb50" }, [
      _c("div", { staticClass: "col-md-12 display-flex bg-white pt-4 " }, [
        _c("div", { staticClass: "col-md-4 filter-pading" }, [
          _c("div", { staticClass: "form-group" }, [
            _c("div", { staticClass: "search_option_two" }, [
              _c("div", { staticClass: "candidate_revew_select" }, [
                _c(
                  "select",
                  {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.searchFilter.progress,
                        expression: "searchFilter.progress"
                      }
                    ],
                    staticClass: "select2-progress compare-opt",
                  ...
                  [
                    _c(
                      "option",
                      { attrs: { value: "Ready for Possessions" } },
                      [
                        _vm._v(
                    ...
                    _vm._v(" "),
                    _c("option", { attrs: { value: "Under Construction" } }, [
                      _vm._v(
                        "\n                                        Under Construction\n                                    "
                      )
                    ]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "Pre-Live" } }, [
                      _vm._v("Pre-Live")
                    ])
                  ]
                )
            ...
            _c("div", { staticClass: "search_option_two" }, [
              _c("div", { staticClass: "candidate_revew_select" }, [
                _c(
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.searchFilter.project_type,
                        expression: "searchFilter.project_type"
                      }
                    ],
                    staticClass: "select2-project-type",
                    attrs: {
                  ...
                  _vm._l(_vm.projecttypes, function(pt, index) {
                    return _c("option", { domProps: { value: pt } }, [
                      _vm._v(
                        "\n                                        " +
                          _vm._s(pt.title) +
                          "\n                                    "
            ...
            _c("div", { staticClass: "search_option_two" }, [
              _c("div", { staticClass: "candidate_revew_select" }, [
                _c(
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.searchFilter.area,
                        expression: "searchFilter.area"
                      }
                    ],
                    staticClass: "select2-area",
                    attrs: {
                      "data-live-search": "true",
                      multiple: "",
                  ...
                  _vm._l(_vm.areas, function(ar, index) {
                    return _c("option", { domProps: { value: ar } }, [
                      _vm._v(
                        "\n                                        " +
                          _vm._s(ar.name) +
                          "\n                                    "
      ...
      _c(
        "div",
        {
          staticClass: "col-md-12 display-flex bg-white pb-4",
          attrs: { id: "frmAddToCompare" }
        },
        [
          _c("div", { staticClass: "col-md-4 filter-pading" }, [
            _c("div", { staticClass: "form-group" }, [
                  ...
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.newCompareReord.project,
                          expression: "newCompareReord.project"
                        }
                      ],
                    ...
                    [
                      ...
                      _vm.filteredProjects.length < 1
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm._l(_vm.filteredProjects, function(fp, index) {
                        return _c("option", { domProps: { value: fp } }, [
                          _vm._v(
                            "\n                                        " +
                              _vm._s(fp.name) +
                              "\n                                    "
          ...
          _c("div", { staticClass: "col-md-4 filter-pading" }, [
            _c(
              "div",
              {
                ...
                class:
                  (_vm.newCompareReord.project || "") != "" &&
                  (_vm.newCompareReord.projectUnit || "") == ""
                    ? "error"
                    : ""
              },
              [
                _c("div", { staticClass: "search_option_two" }, [
                  _c("div", { staticClass: "candidate_revew_select" }, [
                    _c(
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.newCompareReord.projectUnit,
                            expression: "newCompareReord.projectUnit"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                      ...
                      [
                        _c("option", { attrs: { value: "" } }, [
                          _vm._v("--Select Project Units--")
                        ]),
                        _vm._v(" "),
                        _vm.filteredProjectUnits.length < 1
                          ? _c(
                              "option",
                              {
                                staticClass: "text-red",
                          ...
                          : _vm._l(_vm.filteredProjectUnits, function(
                              fpu,
                              index
                            ) {
                              return _c(
                    ...
                    (_vm.newCompareReord.project || "") != "" &&
                    (_vm.newCompareReord.projectUnit || "") == ""
                      ? _c("label", { staticClass: "text-red b-600" }, [
                          _vm._v(
                            "Choose\n                                    the unit"
                          )
                        ])
          ...
          _c("div", { staticClass: "col-md-4 filter-pading" }, [
            _c(
              "button",
              {
                staticClass: "btn btn-log btn-block btn-thm",
                attrs: { type: "button" },
    ...
    _c("div", { staticClass: "row" }, [
      _vm.arrProjectsCompare.length > 0
        ? _c(
            "div",
            {
              staticClass:
                "col-md-12 compare_table_wrapper_payment display-flex p0"
            },
            [
              _c(
                "table",
                {
                  staticClass:
                    "table table-responsive table-bordered table-striped compare_tbl_desktop"
                },
                [
                  _c("thead", { staticClass: "compare_table_head" }, [
                    _c(
                      "tr",
                      [
                        _c("th"),
                        _vm._v(" "),
                        _vm._l(_vm.arrProjectsCompare, function(pc, index) {
                          return _c(
                            "th",
                            { staticClass: "compare_table_width" },
                            [
                              _c(
                                "div",
                                { staticClass: "col-md-12 display-flex-wrap" },
                                [
                                  _c(
                                    "h4",
                                  ...
                                  _c(
                                    "div",
                                    { staticClass: "text-right col-md-4 p-0" },
                                    [
                                      _c(
                                        "a",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.deleteCompareProject(
                                                pc
                                              )
                                            }
                                          }
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "th",
                            { staticStyle: { color: "#54575b !important" } },
                            [_vm._v("Location")]
                          ),
                          _vm._v(" "),
                          _vm._l(_vm.arrProjectsCompare, function(pc, index) {
                            ...
                            return _c(
                              ...
                              [
                                _c(
                                  "div",
                                  { staticClass: "compare_limit_txt" },
                                  _vm._l(pc.owners, function(bldr, index) {
                                    return _c(
                                      "p",
                                      {
                                        staticStyle: {
                            ...
                            return _c(
                              ...
                              [
                                _c(
                                  "div",
                                  {
                                    staticClass: "candidate_revew_select_drop"
                                  },
                                  [
                                    _c(
                                      "select",
                                        ...
                                        directives: [
                                          {
                                            name: "model",
                                            rawName: "v-model",
                                            value: pc.selectedProjectUnitId,
                                            expression:
                                              "pc.selectedProjectUnitId"
                                          }
                                        ],
                                        staticClass: "form-control",
                                        attrs: {
                                          placeholder: "Search Project Unit",
                                          required: ""
                                        },
                                        on: {
                                          change: [
                                            ...
                                            function($event) {
                                              return _vm.changeCompareProjectUnits(
                                                index,
                                                pc
                                              )
                                            }
                                      ...
                                      [
                                        pc.units.length < 1
                                          ...
                                          : _vm._l(pc.units, function(
                                              fpu,
                                              index
                                            ) {
                                              return _c(
                                                "option",
                                                { domProps: { value: fpu.id } },
                                                [
                                                  _vm._v(
                                                    "\n                                        " +
                                                      _vm._s(fpu.title) +
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                                " +
                                        _vm._s(
                                          pc.selectedProjectUnit.type
                                            ? pc.selectedProjectUnit.type.title
                                            : "--"
                                        ) +
                                        "\n                            "
                                    )
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                            " +
                                        _vm._s(
                                          _vm.WordAmount(_vm.amountChecker)
                                        ) +
                                        " "
                                    ),
                                    _c("br"),
                                    _vm._v(
                                      " -->\n                            " +
                                        _vm._s(
                                          _vm.AmountConvertToHalfWord(
                                            Math.floor(
                                              pc.selectedProjectUnit
                                                .total_unit_amount
                                                ? pc.selectedProjectUnit
                                                    .total_unit_amount
                                                : 0
                        ...
                        [
                          ...
                          _vm._l(_vm.arrProjectsCompare, function(pc, index) {
                            return _c(
                              ...
                              { staticClass: "compare_table_width" },
                              [
                                pc.selectedProjectUnit.covered_area != null
                                  ? _c("span", [
                                      _c(
                                        "span",
                                        {
                                      ...
                                      _c(
                                        ...
                                        [
                                          _vm._v(
                                            _vm._s(
                                              pc.selectedProjectUnit.measurement
                                                ? pc.selectedProjectUnit
                                                    .measurement.symbol
                                                : "--"
                                            )
                        ...
                        [
                          ...
                          _vm._l(_vm.arrProjectsCompare, function(pc, index) {
                            return _c(
                              "td",
                              { staticClass: "compare_table_width" },
                              _vm._l(pc.areas, function(ar, index) {
                                return _c(
                                  "p",
                                  {
                                    staticStyle: {
                            ...
                            return _c(
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      _vm._s(pc.selectedProjectUnit.installment)
                                    )
                                  ]
                                )
                              ]
                                    ...
                                    _vm._v(
                                      "\n                            " +
                                        _vm._s(
                                          _vm.AmountConvertToHalfWord(
                                            Math.floor(
                                              pc.selectedProjectUnit.loan_amount
                                                ? pc.selectedProjectUnit
                                                    .loan_amount
                                                : 0
                                            )
                                    ...
                                    _c("img", {
                                      ...
                                      attrs: {
                                        src: pc.selectedProjectUnit
                                          ...
                                          : "",
                                        onerror:
                                          "this.src='/assets/images/not-found.png'"
                                      }
                                    })
                                  ]
                                )
                      ...
                      _vm._v(" "),
                      _vm.arrDistinctRoomTypes.length > 0
                        ? _c("tr", [
                            _c("th", [_vm._v("Additional Details")]),
                            _vm._v(" "),
                            _c(
                              "td",
                              {
                                attrs: {
                                  colspan: _vm.arrProjectsCompare.length
                                }
                              },
                              [
                                _c(
                                  "button",
                                  {
                                    staticClass: "btn btn-thm col-md-12",
                                    attrs: {
                                      type: "button",
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm._l(_vm.arrDistinctRoomTypes, function(rt, rtIndex) {
                        return _c(
                          "tr",
                          {
                            staticClass: "collapse show",
                            attrs: { id: "additional-details-123" }
                          },
                          [
                            _c(
                              "th",
                                  ...
                                  _c("i", {
                                    class:
                                      ...
                                      (rt.objRoomType
                                        ? rt.objRoomType.icon
                                        : ""),
                                    staticStyle: { color: "#ec1c2" }
                                  }),
                                  _vm._v(" :\n                        ")
                                ]),
                                _vm._v(" "),
                                _c("span", [_vm._v(_vm._s(rt.roomTypeName))])
                              ]
                            ),
                            _vm._v(" "),
                            _vm._l(_vm.arrProjectsCompare, function(
                              pc,
                              pcIndex
                            ) {
                              return _c(
                                ...
                                { staticClass: "compare_table_width" },
                                [
                                  pc.selectedProjectUnit.unit_rooms_details[
                                    rtIndex
                                  ].rooms.length > 0
                                    ? _c("div", [
                                        _c(
                                        ...
                                        _c(
                                          ...
                                          {
                                            staticClass:
                                              "collapse show col-md-12 m-t-10",
                                            attrs: {
                                              id:
                                                "additional-details-" +
                                                pc.selectedProjectUnit.id +
                      ...
                      _vm._v(" "),
                      _vm.compareProjectAmenitiesIsFound
                        ? _c(
                            "tr",
                            [
                              _c(
                              ...
                              _vm._l(_vm.arrProjectsCompare, function(
                                ...
                                return _c("td", [
                                  pc.project_amenities.length > 0
                                    ? _c(
                                        "div",
                                        _vm._l(pc.project_amenities, function(
                                          am,
                                          index
                                        ) {
                                          return _c(
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.compareProjectUtilsIsFound
                        ? _c(
                            "tr",
                            [
                              _c(
                              ...
                              _vm._l(_vm.arrProjectsCompare, function(
                                ...
                                return _c("td", [
                                  pc.project_utils.length > 0
                                    ? _c(
                                        "div",
                                        _vm._l(pc.project_utils, function(
                                          ut,
                                          index
                                        ) {
                                          return _c(
              ...
              _c(
                ...
                {
                  staticClass:
                    "table table-bordered table-striped compare_tbl_mobile",
                      ...
                      _c(
                        ...
                        _vm._l(_vm.arrProjectsCompare, function(pc, index) {
                          return _c(
                            "td",
                            {
                              staticStyle: { width: "50%", "font-size": "17px" }
                            },
                            [
                              _c("div", [
                                _c(
                                ...
                                _c(
                                  "a",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.deleteCompareProject(pc)
                                      }
                                    }
                                  },
                                  [
                      ...
                      _c(
                        ...
                        _vm._l(_vm.arrProjectsCompare, function(pc, index) {
                          return _c(
                            ...
                            [
                              _c("div", [
                                _c("div", { staticClass: "comparison-item" }, [
                                  _c("img", {
                                    attrs: {
                                      width: "100%",
                                      height: "100%",
                                      ...
                                      directives: [
                                        {
                                          ...
                                          rawName: "v-model",
                                          value: pc.selectedProjectUnitId,
                                          expression: "pc.selectedProjectUnitId"
                                        }
                                      ],
                                      staticClass: "form-control",
                                      attrs: {
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      Math.floor(
                                        pc.selectedProjectUnit.total_unit_amount
                                          ? pc.selectedProjectUnit
                                              .total_unit_amount
                                          : 0
                                      ).toString()
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-lg-6" }, [
        _c("div", { staticClass: "breadcrumb_content style2 mb0-991" }, [
          _c("ol", { staticClass: "breadcrumb" }, [
            ...
            _c(
              "li",
              {
                staticClass: "breadcrumb-item active text-thm",
          ...
          _vm._v(" "),
          _c("h2", { staticClass: "breadcrumb_title" }, [_vm._v("Compare")])
        ])
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("th", { staticStyle: { color: "#54575b !important" } }, [
      _vm._v("Projet Unit "),
    ...
    return _c(
      ...
      [
        _c("tr", [
          _c("th", [_vm._v("SNo.")]),
          _vm._v(" "),
          _c("th", [_c("span", [_vm._v("Dimensions")])])
        ])
      ]
    )
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("thead", { staticClass: "compare_tbl_heading" }, [
      _c("tr", [
