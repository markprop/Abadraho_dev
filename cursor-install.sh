...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2025.09.04-fc40cd1-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2025.09.04-fc40cd1/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2025.09.04-fc40cd1"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2025.09.04-fc40cd1/cursor-agent ~/.local/bin/cursor-agent
