...
class UserSearchHistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        // $userHistorys = UserSearchHistory::orderBy('created_at', 'DESC')->where('search_type', 'filter')->orWhere('search_type', NULL)->get();
    ...
    public function housingSearch(Request $request)
    {
        ...
        $userHistorys = $userHistorys->where('search_type', 'calculator')->get();
