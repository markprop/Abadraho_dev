  ...
  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <!--begin::Title-->
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Builder</h5>
        <!--end::Title-->
        <!--begin::Separator-->
    ...
    <div class="container">
      ...
      <div class="card card-custom gutter-b example example-compact">
        <div class="card-header" style="padding: 1rem 1.25rem;">
          <h2 class="card-title text-uppercase">Edit Builder</h2>
        </div>
        <!--begin::Form-->
        <form class="form mt-5 ml-10 mr-10" method="POST" action="/admin/builder/{{ $builder->id }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-xl-12">
              <div class="form-group fv-plugins-icon-container">
                ...
                <input type="text" class="form-control form-control-lg" name="full_name" value="{{ $builder->full_name }}" required>
            ...
            <div class="col-xl-12">
              <div class="form-group fv-plugins-icon-container">
                ...
                <input type="text" class="form-control form-control-lg" name="contact_person_name" value="{{ $builder->contact_person_name }}">
            ...
            <div class="col-xl-8">
              <div class="form-group fv-plugins-icon-container">
                <label>Email</label>
                <input type="email" class="form-control form-control-lg" name="contact_person_email" value="{{ $builder->contact_person_email }}">
            ...
            <div class="col-xl-4">
              <div class="form-group fv-plugins-icon-container">
                ...
                <input id="contact_person_phone_number" type="tel" class="form-control h50 pretext-phone-number mt20" name="contact_person_phone_number" value="{{ $builder->contact_person_phone_number }}" style="width:100% !important" />
