          ...
          <table class="datatable datatable-bordered datatable-head-custom table-bordered text-center" id="kt_datatable">
            ...
            <thead>
              ...
              <tr>
                ...
                <th title="Field #2">Area Name</th>

                <th title="Field #2">Slug Name</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="/admin/area/{{ $area->id }}/edit"><i class="fa fa-edit ml-2"></i></a>

                  <a onclick="deletetIsArchive('{{ $area->id }}')" href="javascript:void(0)">
...
<script>
  ...
  function deletetIsArchive(area_id) {

    // console.log("deletetIsArchive -> User -> id -> ", area_id);
    ...
    if (parseInt(area_id)) {
      ...
      ShowSweetAlertConfirm({
        ...
        if (result.isConfirmed) {
          ...
          let requestRoute = "/admin/area/delete";
          ...
          CallLaravelAction(requestRoute, requestParams, function(response) {
            ...
            if (response.status) {
              ...
              if (typeof response.error !== "undefined") {
                ...
                if (typeof response.error.area_id !== "undefined") {

                  ErrorMsg = response.error.area_id;
