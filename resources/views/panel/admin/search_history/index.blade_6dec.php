                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                                            ...
                                                            <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                                                ...
                                                                <select class="selectpicker" name="area[]" multiple
                                                                    ...
                                                                    @foreach (\App\Models\Area::get() as $obj){
                                                                        <option value="{{ $obj['id'] }}"
                                                                            @if ($searchQuery['area']) @foreach ($searchQuery['area'] as $area)
                                    @if ($obj->id == $area)
                                    selected @endif
                                                                            @endforeach
                                                                    @endif
                                                                ...
                                                                <select class="selectpicker" name="progress[]" multiple
                                                                    ...
                                                                    @foreach (\App\Models\Progress::get() as $obj){
                                                                        <option value="{{ $obj['progress_status_name'] }}"
                                                                            @if ($searchQuery['progress']) @foreach ($searchQuery['progress'] as $progress)
                                                            ...
                                                            <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                                                ...
                                                                <select class="selectpicker" name="type[]" multiple
                                                                    ...
                                                                    @foreach (\App\Models\ProjectType::get() as $obj){
                                                                        <option value="{{ $obj['id'] }}"
                                                                            @if ($searchQuery['type']) @foreach ($searchQuery['type'] as $type)
                                    @if ($obj->id == $type)
                                    selected @endif
                                                                            @endforeach
                                                                    @endif
                                                            ...
                                                            <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                                                ...
                                                                <select class="selectpicker" name="builder[]" multiple
                                                                    multiple multiple data-live-search="true"
                                                                    data-actions-box="true"
                                                                    data-live-search-placeholder="Search">
                                                                    ...
                                                                    @foreach (\App\Models\Builder::get() as $obj){
                                                                        <option value="{{ $obj['id'] }}"
                                                                            @if ($searchQuery['builder']) @foreach ($searchQuery['builder'] as $builder)
                                    @if ($obj->id == $builder)
                                    selected @endif
                                                                            @endforeach
                                                                    @endif
                                                        ...
                                                        <div class="form-row" style="margin-top: 3%;" id="input-fields">
                                                            <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                                                ...
                                                                <input class="form-control" name="minDownPayment"
                                                                    type="number" placeholder="Min Down Payment"
                                                                    min="0"
                                                                    value={{ $searchQuery['minDownPayment'] }}>
                                                            </div>
                                                            <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                                                <label class="search_heading">Max Down Payment</label>
                                                                <input class="form-control" name="maxDownPayment"
                                                                    type="number" placeholder="Max Down Payment"
                                                                    min="0"
                                                                    value={{ $searchQuery['maxDownPayment'] }}>
                                                            </div>
                                                            <div class="col-12 col-md-2 col-lg-2 col-xl-3">
                                                                <label class="search_heading">Min Monthly
                                                                    Installment</label>
                                                                <input class="form-control" name="minMonthlyInstall"
                                                                    type="number" placeholder="Min Monthly Installment"
                                                                    min="0"
                                                                    value={{ $searchQuery['minMonthlyInstall'] }}>
                                                            </div>

                                                            <div class="col-12 col-md-2 col-lg-2 col-xl-3">
                                                                <label class="search_heading">Max Monthly
                                                                    Installment</label>
                                                                <input class="form-control" name="maxMonthlyInstall"
                                                                    type="number" placeholder="Max Monthly Installment"
                                                                    min="0"
                                                                    value={{ $searchQuery['maxMonthlyInstall'] }}>
                                                            </div>
                                                        ...
                                                        <div class="form-row" style="margin-top: 3%;" id="input-fields">
                                                            ...
                                                            <div class="col-12 col-md-2 col-lg-2 col-xl-2">
                                                                ...
                                                                <input type="date" name="from" max="3000-12-31"
                                                                    min="1000-01-01" class="form-control" min="0"
                                    ...
                                    <select class="selectpicker col-6 col-lg-4" name="field[]" id="selectedFields"
                                        multiple multiple multiple data-live-search="true"
                                        data-live-search-placeholder="Search">
                        ...
                        <div class="table_wrapper table_wrapper_payment">
                            <table class="datatable datatable-bordered  table_wrapper table-bordered text-center"
                                id="kt_datatable">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($userHistorys as $userHistory)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($searchData[$loop->index]['progress'])
                                                    @foreach ($searchData[$loop->index]['progress'] as $progress)
                                                        {{ \App\Models\Progress::where(['progress_status_name' => $progress])->pluck('progress_status_name')->first() }}
                                                        {{ !$loop->last ? ', ' : '' }}
                                                    @endforeach
                                                @else
                                                    -
                                            ...
                                            <td>{{ $searchData[$loop->index]['minDP'] ? number_format($searchData[$loop->index]['minDP']) : '-' }}
                                            </td>
                                            <td>{{ $searchData[$loop->index]['maxDP'] ? number_format($searchData[$loop->index]['maxDP']) : '-' }}
                                            </td>
                                            <td>{{ $searchData[$loop->index]['minMI'] ? number_format($searchData[$loop->index]['minMI']) : '-' }}
                                            </td>
                                            <td>{{ $searchData[$loop->index]['maxMI'] ? number_format($searchData[$loop->index]['maxMI']) : '-' }}
                                            </td>
                                            <td>{{ $searchData[$loop->index]['minPrice'] ? number_format($searchData[$loop->index]['minPrice']) : '-' }}
                                            </td>
                                            <td>{{ $searchData[$loop->index]['maxPrice'] ? number_format($searchData[$loop->index]['maxPrice']) : '-' }}
                                            </td>
...
@section('footer')
    ...
    <script>
        ...
        function downloadData() {
            ...
            window.open(
                `${window.location.origin}/admin/searchHistory/export?fields=${selectedFields}&searchQuery=${btoa(searchQuery)}`
                )
        }
    </script>
@endsection
