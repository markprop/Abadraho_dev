    ...
    <div class="d-flex flex-column-fluid">
      ...
      <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
          ...
          <!--begin::Form-->
          <form class="form mt-5" method="POST" action="/admin/blog_category">
            @csrf
            ...
            <div class="form-group fv-plugins-icon-container">
                ...
                <span class="form-text text-muted">Please enter your Blog Category Name.</span>
                @error('title')
              ...
              <div class="form-group fv-plugins-icon-container">
                ...
                <span class="form-text text-muted">Please enter your Blog Slug Name.</span>
                @error('slug')
                  <div class="fv-plugins-message-container text-danger">{{ $message }}</div>
                @enderror
              </div>
