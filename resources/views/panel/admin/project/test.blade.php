                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                                ...
                                <div class="alert-text">The Metronic KTDatatable supports sub-datatable with local data
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">Sub-datatable Demo
                                            <span class="d-block text-muted pt-2 font-size-sm">Sub-datatable examples
                                                with local datasource</span>
                                        </h3>
                                    </div>
