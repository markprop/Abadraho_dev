              ...
              <div class="container">
                ...
                <div class="card" style="margin-bottom: 2%;">
                  ...
                  <div class="card-body">
                    ...
                    <form method="GET" action="/admin/project">
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-12 col-md-4 col-lg-4 col-xl-4">
                          ...
                          <select class="selectpicker" name="progress[]" multiple multiple multiple data-live-search="true" data-actions-box="true" data-live-search-placeholder="Search">
                            ...
                            <option value={{ $progress['id'] }} @if($searchQuery['progress']) @foreach($searchQuery['progress'] as $obj) @if($progress['id']==$obj) selected @endif @endforeach @endif>
                      ...
                      <div class="form-row" style="margin-top: 2%;">
                        ...
                        <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                          ...
                          <label class="search_heading">Status</label>

                          <select class="selectpicker" name="status[]" multiple multiple multiple data-live-search="true" data-actions-box="true" data-live-search-placeholder="Search">



                            <option value="1" @if($searchQuery['status']) @foreach($searchQuery['status'] as $obj) @if('1'==$obj) selected @endif @endforeach @endif>
                            ...
                            <option value="2" @if($searchQuery['status']) @foreach($searchQuery['status'] as $obj) @if('2'==$obj) selected @endif @endforeach @endif>
                            ...
                            <option value="3" @if($searchQuery['status']) @foreach($searchQuery['status'] as $obj) @if('3'==$obj) selected @endif @endforeach @endif>
          ...
          if (parseInt(project_id)) {
            ...
            ShowSweetAlertConfirm({
              ...
              if (result.isConfirmed) {
                ...
                let requestRoute = "/admin/project/" + project_id;
