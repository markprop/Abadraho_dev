        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
              ...
              <a href="" class="text-muted">Room Types</a>
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          ...
          <div class="col-xs-6">
            ...
            <div class="card-title">
              ...
              <h3 class="card-label">Room Types</h3>
          ...
          <table class="datatable datatable-bordered datatable-head-custom table-bordered text-center" id="kt_datatable">
            ...
            <thead>
              ...
              <tr>
                ...
                <th title="Field #2">Room Type Name</th>

                <th title="Field #3">Icon</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><i class="fa {{ $roomType->icon }}"></i></td>

                <td>

                  <a href="/admin/room_type/{{ $roomType->id }}/edit"><i class="fa fa-edit ml-2"></i></a>

                  <a onclick="deletetIsArchive('{{ $roomType->id }}')" href="javascript:void(0)">
...
<script>
  ...
  function deletetIsArchive(room_type_id) {

    // console.log("deletetIsArchive -> User -> id -> ", room_type_id);

    if (parseInt(room_type_id)) {
      ...
      ShowSweetAlertConfirm({
        ...
        if (result.isConfirmed) {
          ...
          let requestRoute = "/admin/room_type/delete";
