                    ...
                    <div class="sidebar_advanced_search_widget">
                        ...
                        <form id="zohoInquiryForm">
                            ...
                            <div class="row" style="font-size: 12px;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea id="address" name="address" class="form-control" rows="2" placeholder="Please provide your address" required></textarea>
                    ...
                    <div class="sidebar_advanced_search_widget">
                        ...
                        <form>
                            <div class="row" style="font-size: 12px;">
                                <div class="col-md-12">
                                    <div class="search_option_button">
                                        <a href="/projects/generate-voucher/{{$project->id}}" type="btn" class="btn btn-block btn-thm"><i class="fa fa-paper-plane"></i> Get Your Voucher Code
                                        </a>
                                    </div>
                                </div>
                            </div>
