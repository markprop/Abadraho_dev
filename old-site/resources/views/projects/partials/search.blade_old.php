<div class="row search_filter_section">
    <div class="col-md-9 col-lg-9 filter-section">
        <div class="">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="shortcode_widget_multiselect">
                                        ...
                                        <div class="ui_kit_multi_select_box">
                                            <select class="select2-area form-control" name="area[]" multiple="multiple">
                                                <option disabled value="">Select Areas</option>
                                                @foreach ($areas as $area)
                                                    <option value="{{ $area->id }}"
                                                        <?php if(isset($areaId)) { ?>
                                                            @if($areaId == $area->id) selected @endif>
                                                        <?php } ?>
                                                        {{ $area->name }}
                                                    </option>
                                                @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="shortcode_widget_multiselect">
                                        ...
                                        <div class="ui_kit_multi_select_box">
                                            <select class="select2-project-type" name="type_id[]"
                                                    multiple="multiple">
                                                <option disabled value="">Select Project Type</option>
                                                @foreach ($projectTypes as $projectType)
                                                    <option value="{{ $projectType->id }}"
                                                        <?php if(isset($areaId)) { ?>
                                                            @if($projecttypeId == $projectType->id) selected @endif>
                                                        <?php } ?>
                                                        {{ $projectType->title }}
                                                    </option>
                                                @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" min="0" class="form-control" placeholder="Max Down Payment"
                                           name="maxDP"
                            ...
                            <div class="col-md-3 toggle-advanced-fields hide">
                                <div class="form-group">
                                    ...
                                    <select class="select2-progress" placeholder="Progress"
                                            name="progress[]"
                                            multiple="multiple">
                            ...
                            <div class="col-md-3 toggle-advanced-fields hide">
                                <div class="form-group">
                                    ...
                                    <select class="select2-builder" placeholder="Builder"
                                            name="builder[]"
                                            multiple="multiple">
                            ...
                            <div class="col-md-3 toggle-advanced-fields hide">
                                <div class="form-group">
                                    ...
                                    <select class="select2-tags" placeholder="Tags"
