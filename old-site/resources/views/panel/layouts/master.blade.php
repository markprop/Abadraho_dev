...
<head>
    ...
    <link href="{{ asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="{{ asset('assets/plugins/global/plugins.bundle.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/style.bundle.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="{{ asset('assets/css/themes/layout/header/base/light.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/themes/layout/header/menu/light.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/themes/layout/brand/light.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/themes/layout/aside/light.css?v=7.2.7') }}" rel="stylesheet" type="text/css" />
    ...
    <!--begin::Import Page Specific CSS(used by a specific page)-->
    @yield('header')
    <!--end::Import Page Specific CSS(used by a specific page)-->
    <!--end::Layout Themes-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu" style="display: none; overflow: hidden;" kt-hidden-height="120">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/admin/project/create" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
    ...
    <script src="{{ asset('assets/plugins/global/plugins.bundle.js?v=7.2.7') }}"></script>
    <script src="{{ asset('assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.2.7') }}"></script>
    <script src="{{ asset('assets/js/scripts.bundle.js?v=7.2.7') }}"></script>
    <!--end::Global Theme Bundle-->
    <!--begin::Page Vendors(used by this page)-->
    {{-- <script src="{{ asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.2.7') }}"></script> --}}
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    {{-- <script src="{{ asset('assets/js/pages/widgets.js?v=7.2.7') }}"></script> --}}
    ...
    <!--end::Page Scripts-->
    <!--begin::Import Page Specific JS(used by a specific page)-->
    @yield('footer')
    <!--end::Import Page Specific JS(used by a specific page)-->
</body>
<!--end::Body-->
