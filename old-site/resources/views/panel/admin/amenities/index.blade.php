        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item text-muted">
              <a href="" class="text-muted">Amenities</a>
            </li>
          </ul>
          <!--end::Breadcrumb-->
        </div>
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="col-xs-6">
            <div class="card-title">
              <h3 class="card-label">Amenities Details</h3>
            </div>
          </div>
          ...
          <table class="datatable datatable-bordered datatable-head-custom table-bordered text-center" id="kt_datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/admin/amenities/{{ $amenity->id }}/edit"><i class="fa fa-edit ml-2"></i></a>
                  <a onclick="deletetIsArchive('{{ $amenity->id }}')" href="javascript:void(0)">
...
<script>
  function deletetIsArchive(amenity_id) {
    // console.log("deletetIsArchive -> User -> id -> ", amenity_id);
    if (parseInt(amenity_id)) {
      ShowSweetAlertConfirm({
        ...
        if (result.isConfirmed) {
          let requestRoute = "/admin/amenities/delete";
          let requestParams = {
          ...
          CallLaravelAction(requestRoute, requestParams, function(response) {
            if (response.status) {
              ...
              if (typeof response.error !== "undefined") {
                if (typeof response.error.amenity_id !== "undefined") {
                  ErrorMsg = response.error.amenity_id;
                }
              }
              let SweetAlertParams = {
                icon: "error",
