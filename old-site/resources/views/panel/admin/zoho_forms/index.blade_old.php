            ...
            <div class="mb-7">
              <div class="row align-items-center">
                <div class="col-lg-12">
                      ...
                      <div class="card" style="margin-bottom: 2%;">
                          ...
                          @csrf
                              <div class="form-row">
                                ...
                                <input class="form-control" name="name" type="text" placeholder="Name" value={{ $searchQuery['name']}}>
                                </div>
                                <div class="col-12 col-md-3 col-lg-3 col-xl-3">

                                <label class="search_heading">Email</label>   
                                <input class="form-control" name="email" type="email" placeholder="Email" value={{ $searchQuery['email']}}>
                                
                                </div>
                                <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                
                                <label class="search_heading">Phone</label> <br>    
                                <input class="form-control" name="phone_number" type="number" placeholder="Phone" min="0" value={{ $searchQuery['phone_number']}}>
                                ...
                                <input class="form-control" name="address" type="text" placeholder="Address" value={{ $searchQuery['address']}}>
                              ...
                              <div class="form-row" style="margin-top: 3%;">
                                <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                <label class="search_heading">Project Interested In</label>  <br>
                                <select class="selectpicker"onChange="handleChange()" name="project_id[]" multiple multiple multiple data-live-search="true" data-actions-box="true" data-live-search-placeholder="Search">
                                    @foreach($allProjects as $project)
                                      <option value={{ $project['id'] }}
                                      @if($searchQuery['project_id'])
                                        @foreach($searchQuery['project_id'] as $obj)
                                          @if($obj == $project['id'])
                                          selected
                                          @endif
                                        @endforeach
                                ...
                                <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                                <label class="search_heading">Unit Interested In</label> <br>
                                ...
                                @foreach(\App\Models\Unit::get() as $unit)
                                      ...
                                      @if($searchQuery['unit_id'])
                                        @foreach($searchQuery['unit_id'] as $obj)
                                          @if($obj == $unit['id'])
                                          selected
                                          @endif
                                        @endforeach
                  ...
                  <select class="selectpicker col-6 col-lg-4" name="field[]" id="selectedFields" multiple multiple multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true">
              ...
              <tbody>
                @foreach ($inquiries as $inquiry)
                  <tr>
                    ...
                    <td><a href="/admin/listing/{{ $inquiry->id }}"><i class="fa fa-eye ml-2"></i></a>
...
@section('footer')
  ...
  function downloadData(){
    ...
    window.open(`${window.location.origin}/admin/export/listing?fields=${selectedFields}&searchQuery=${btoa(searchQuery)}`)
  }
  </script>
@endsection
