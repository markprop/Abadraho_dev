    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
      <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
          <!--begin::Title-->
          <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Update Utilities</h5>
          <!--end::Title-->
          <!--begin::Separator-->
      ...
      <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
          <div class="card-header" style="padding: 1rem 1.25rem;">
            <h2 class="card-title text-uppercase">Update Utilities</h2>
          </div>
          <!--begin::Form-->
          <form class="form mt-5 ml-10 mr-10" method="POST" action="/admin/utilities/{{ $utility->id }}" enctype="multipart/form-data">
          @csrf
            @method('PUT')
            <div class="row">
              <div class="col-xl-12">
                <div class="form-group fv-plugins-icon-container">
                  <label>Name</label>
                  <input type="text" class="form-control form-control-lg" value="{{ $utility->utility_name }}" name="utility_name" required>
                ...
                <div class="form-group fv-plugins-icon-container icon-select">
                  ...
                  <select name="is_active" id="" class="form-control form-control-lg" required>
                    ...
                    <option value="1" {{ $utility->is_active == 1 ? 'selected' : '' }}>Yes</option>
                    <option value="0" {{ $utility->is_active == 0 ? 'selected' : '' }}>No</option>
                  </select>
