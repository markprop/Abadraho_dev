      ...
      <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
          <div class="card-header" style="padding: 1rem 1.25rem;">
            <h2 class="card-title text-uppercase">Edit Project Type</h2>
          </div>
          <!--begin::Form-->
          <form class="form mt-5" method="POST" action="/admin/project_type/{{ $projectType->id }}"
            ...
            <div class="col-xl-12">
              <div class="form-group fv-plugins-icon-container">
                ...
                <input type="text" class="form-control form-control-lg" name="title" value="{{ $projectType->title }}">
                <span class="form-text text-muted">Please enter your project type
                  Name.</span>
                @error('title')
